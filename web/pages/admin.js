...
export default function admin({ error, players, survivors }) {
            ...
            <div className="w-full p-2 border border-red-500 rounded">
              ...
              <div className="flex flex-col justify-center w-full md:flex-row">
                ...
                <button
                  className="p-1 mb-2 border rounded md:ml-2"
                  onClick={() =>
                    resetScores(players, survivors, setIsSubmitting)
                  }
                >
                  Reset scores
                </button>
...
export const getServerSideProps = withPageAuthRequired({
  async getServerSideProps({ req, res }) {
    ...
    if (
      !session?.user['https://www.tannerwiltshire.com/roles'].includes('admin')
    ) {
      return { props: { error: 'Unauthorized', survivors, players } };
    } else {
      return {
        props: {
          survivors,
